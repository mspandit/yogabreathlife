...
<!-- Begin Masthead -->
<div id="masthead">
 <h4 class="left"><a href="<?php bloginfo('home'); ?>/" title="Home" class="logo"><img src="wp-content/themes/high-def-child/images/YBLTITLEBAR.jpg" /></a> <span class="description"><?php bloginfo('description'); ?></span></h4>
</div>
